...
if (!empty($searchKeyword)) {
    $query .= " WHERE id_buku LIKE '%$searchKeyword%' OR judul LIKE '%$searchKeyword%'";
}
?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="container-fluid">
                                ...
                                <!-- Form Pencarian -->
                                <form action="buku.php" method="GET" class="mb-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Cari berdasarkan ID atau Judul" name="q">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary"><a class="collapse-item" href="buku.php?q=">Daftar Buku</a>
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <!-- Tampilkan daftar buku disini -->
                                    </div>
                                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form method="post" action="konfing_tambah.php">
